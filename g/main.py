...
class SecondScr(Screen):
    ...
    def change_text(self):
        self.txt.text = self.input.text + " це якесь повідомлення"
...
#        test_btn1 = Button(text = "Текстова кнопка 1")
#        test_btn2 = Button(text = "Текстова кнопка 2")
#        test_btn3 = Button(text = "Текстова кнопка 3")
#        test_btn4 = Button(text = "Текстова кнопка 4")
